...
import com.heipl.uploadingfiles.storage.exception.StorageException;
...
public class FileSystemStorageService implements StorageService {
    ...
    public void store(final MultipartFile file) {
        try {
            ...
            final Path fileName = Paths.get(file.getOriginalFilename());
            final Path destinationFile = this.rootLocation.resolve(fileName)
                                                          .normalize()
                                                          .toAbsolutePath();
